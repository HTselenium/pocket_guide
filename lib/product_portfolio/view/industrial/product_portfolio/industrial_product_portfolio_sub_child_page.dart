...
class IndustrialProductPortfolioSubChild extends StatefulWidget {
  const IndustrialProductPortfolioSubChild({
    super.key,
    required this.id,
  ...
  @override
  State<IndustrialProductPortfolioSubChild> createState() =>
      _IndustrialProductPortfolioSubChildState();
}

class _IndustrialProductPortfolioSubChildState
    extends State<IndustrialProductPortfolioSubChild> {
  ...
  void initState() {
    ...
    for (final productId in _productIdList) {
      productIdListData.add(industryProductBox.get(productId));
    }
  }
                  ...
                  (i) {
                    return CustomListTile(
                      ...
                      onPressed: () {
                        ...
                        context.push(
                          '${AppRoutes.productPortfolioIndustrial.path}/product/${widget.category}/$i/$i/$i',
